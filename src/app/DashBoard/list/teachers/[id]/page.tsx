...
const SHORTCUTS = [
  ...
  { label: "Students",    href: "/", color: "bg-sky-100    text-sky-800    hover:bg-sky-200"       },
        ...
        <aside className="flex flex-col gap-6">
          ...
          <div className="rounded-2xl bg-white shadow-sm border border-slate-100 overflow-hidden">
            ...
            <div className="px-6 pb-6">
              ...
              <p className="text-sm text-emerald-600 font-medium mt-0.5">Senior Teacher · Math Dept.</p>
              <p className="text-sm text-slate-500 mt-2 leading-relaxed">
                Professional educator with 8+ years of experience in secondary education.
              </p>
              ...
              <ul className="mt-5 space-y-2.5 text-sm">
                {[
                  ...
                  { icon: "/date.png",  text: "Joined January 2025" },
          ...
          <div className="rounded-2xl bg-white border border-slate-100 shadow-sm p-6 flex-1">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <h2 className="text-xl font-bold text-slate-800 mt-0.5">Teaching Schedule</h2>
              </div>
